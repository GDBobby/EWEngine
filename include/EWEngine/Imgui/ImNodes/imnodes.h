...
// bobby custom
enum ImNodesAttributeType : int {
    ImNodesAttributeType_None,
    ImNodesAttributeType_Input,
    ImNodesAttributeType_Output
};

bool BeginPinAttribute(const int id, const ImVec2 pinOffset, const ImNodesAttributeType ImNodesAttributeType_Input = ImNodesAttributeType_None, ImNodesPinShape shape = ImNodesPinShape_CircleFilled);
void BeginPinAttribute(const int id, const ImNodesAttributeType ImNodesAttributeType_Input = ImNodesAttributeType_None, ImNodesPinShape shape = ImNodesPinShape_CircleFilled);
